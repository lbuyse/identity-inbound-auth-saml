...
public class SAMLSSOProviderServlet extends HttpServlet {
            ...
            if (sessionDataKey != null) { //Response from common authentication framework.
                ...
                if (sessionDTO != null) {
                    ...
                    if (sessionDTO.isInvalidLogout()) {
                        ...
                        resp.sendRedirect(getRedirectURL(defaultLogoutLocation + queryParams, req));
    ...
    private void sendNotification(String errorResp, String status, String message,
        ...
        resp.sendRedirect(getRedirectURL(queryAppendedUrl, req));
    }
    ...
    private void handleIdPInitSSO(HttpServletRequest req, HttpServletResponse resp, String relayState,
                                  ...
                                  boolean isPost, boolean isLogout) throws IdentityException,
        ...
        String defaultLogoutLocation = getRedirectURL(SAMLSSOUtil.getDefaultLogoutEndpoint(), req);
            ...
            if (sessionDTO.getValidationRespDTO().isPassive()) { //if passive
                ...
                if (authResult != null) {
                    if (!authResult.isAuthenticated()) {
                        ...
                        throw IdentityException.error(IdentityException.class, "Could not find session state information " +
                                "" + "for issuer : " + issuer + " in tenant domain : " + tenantDomain + " for session " +
                                "identifier : " + sessionDataKey);
                    }
                } else {
                    throw IdentityException.error(IdentityException.class, "Could not find result information " +
                            "" + "for issuer : " + issuer + " in tenant domain : " + tenantDomain + " for session " +
                            "identifier : " + sessionDataKey);
                }
            }
    ...
    private static String getRedirectURL(String redirectURL, HttpServletRequest request) throws
